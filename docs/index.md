...
<div class="platform-compat">
  ...
  <a href="/SpecArk/installation" class="compat-badge compat-codex">
    <svg class="compat-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" aria-label="OpenAI">
  ...
  <a href="/SpecArk/installation-claude-code" class="compat-badge compat-claude">
    <svg class="compat-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" aria-label="Anthropic">
