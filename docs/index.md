...
hero:
  ...
  tagline: "A Git-distributed Codex plugin that turns SPDD into an explicit, file-driven workflow for story creation, analysis, prompt generation, implementation, and sync."
  actions:
    - theme: brand
      text: Get Started
