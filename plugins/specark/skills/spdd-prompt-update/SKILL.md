...
Use this skill only to update an existing SPDD prompt after requirements, architectural assumptions, or design constraints change.

## Required Execution Contract

1. Read `../../references/source-commands/spdd-prompt-update.md` completely every time this skill runs.
