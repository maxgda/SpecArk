...
Use this skill only to implement code from an SPDD REASONS Canvas prompt artifact.

## Required Execution Contract

1. Read `../../references/source-commands/spdd-generate.md` completely every time this skill runs.
...
output_files:
- <changed-file>
next_phase: spdd-api-test|complete
